...
#Now I know when the first correct switched occurred, now I need to calculate the latency so from 360 post noun onset
#how much delay was there to the first correct switch so switch time - 360?
