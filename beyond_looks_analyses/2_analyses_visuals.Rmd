...
#I think if we know right versus left image, we can calculate how many times the right image was the target, how many times it was the distractor, and substract by media name looks to the right (relative to the left = proportion) when the right was target minus looks to the right when the right (relative to the left = proportion) was distractor. Then ungroup, group by subject and average the proportion difference by subject.
