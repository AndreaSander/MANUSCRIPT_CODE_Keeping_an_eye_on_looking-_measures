...
ungroup() %>%
  group_by(study)%>%
  group_modify(~ tibble(icc = list(ICC(.x[ ,3:12], missing = FALSE, lmer = TRUE, alpha = 0.05)))) #This line of code makes a loop which applies the ICC function by study, to the experimental data in order to get an ICC3k value per study.
