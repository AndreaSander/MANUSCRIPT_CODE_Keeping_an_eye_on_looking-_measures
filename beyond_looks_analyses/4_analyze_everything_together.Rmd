...
print_list[[paste("ICC Means:")]] <- icc_means
...
print_list[[paste("Models - Experimental, all, archival, simple")]] <- purrr::map(models$experimental_all_archival$simple, summary)
print_list[[paste("Models - Experimental, all, archival, interaction")]] <- purrr::map(models$experimental_all_archival$inter, summary)
print_list[[paste("Models - Non-xperimental, all, archival, simple")]] <- purrr::map(models$`non-experimental_all_archival`$simple, summary) 
print_list[[paste("Models - Non-xperimental, all, archival, interaction")]] <- purrr::map(models$`non-experimental_all_archival`$inter, summary) 
print_list[[paste("Models - Experimental, all, peekbank, simple")]] <- purrr::map(models$experimental_all_peekbank$simple, summary) 
print_list[[paste("Models - Non-experimental, all, peekbank, simple")]] <- purrr::map(models$`non-experimental_all_peekbank`$simple, summary) 
